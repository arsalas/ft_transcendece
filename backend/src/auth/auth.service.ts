...
export class AuthService {
  ...
  private async signIn42(code: string): Promise<IUser42> {
    ...
    try {
      const body = {
        client_id:
          'u-s4t2ud-002f8307ed61fa03609f72d495d3a6e7efe6c446b08744c9b33e4ea27e613829',
        grant_type: 'authorization_code',
        client_secret:
          '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',
        code, // su valor va a ser el mismo que la variable
        redirect_uri: 'http://localhost:5173/auth/confirm',
      };
      console.log(body);

      const response: AxiosResponse<IOauth> = await axios.post(
        'https://api.intra.42.fr/oauth/token',
        body,
      );
      const data = response.data;
      const resp: AxiosResponse<IUser42> = await axios.get(
