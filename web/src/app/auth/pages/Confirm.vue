						...
						<div class="columns">
							<div class="column">
								<button type="submit" class="button is-primary is-fullwidth is-outlined"
									@click="router.push({ name: 'signin' })">Cancel</button>
							</div>
							<div class="column">
								<button type="submit" class="button is-primary is-fullwidth"
									:class="{ 'is-loading': isLoadingTFA }">Send</button>
							</div>
						</div>
					</div>
				</form>
...
const Loader = defineAsyncComponent(() => import('../../common/components/Loader.vue'))
...
const handleSubmit = async () => {
	try {
		...
		const response = await authService.confirmTFA({ token: code.value, ...tfaData.value });
