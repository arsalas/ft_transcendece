			...
			<div class="columns mt-2">
				<div class="column">
					<a href="https://itunes.apple.com/us/app/artstation-app/id924645286" target="_blank">
						<QRCode icon="fa-brands fa-google-play" image="qr_android.png" text="Google Play" haveFooter />
					</a>
				</div>
				<div class="column">
					<a href="https://itunes.apple.com/us/app/artstation-app/id924645286" target="_blank">
						<QRCode icon="fa-brands fa-apple" image="qr_ios.png" text="App Store" haveFooter />
					</a>
				</div>
			</div>
		</template>
