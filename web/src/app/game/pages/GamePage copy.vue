...
const renderCanvas = () => {
	...
	// Jugador
	context.fillStyle = 'black';
	context.fillRect(paddlePlayerX, height - 10 - paddleHeight, paddleWidth, paddleHeight);
...
const computerPaddle = () => {
	...
	if (paddleComputerX + paddleDiff > Math.floor(ballX) + 5 || paddleComputerX + paddleDiff < Math.floor(ballX) - 5) {
